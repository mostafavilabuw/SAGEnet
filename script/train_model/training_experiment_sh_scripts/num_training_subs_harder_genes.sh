...
lam_ref=1
lam_diff=10
exp_label=num_training_subs_harder_genes

training_subs_set_sizes=(5 50 200 400 689)
for num_training_subs in "${training_subs_set_sizes[@]}"; do
    sbatch --nodes=${num_nodes} --export=ALL,num_training_subs=${num_training_subs} run_train_model.sh
done 
